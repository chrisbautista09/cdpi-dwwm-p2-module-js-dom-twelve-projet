...
// 0. On récupère les icônes soleil/lune dans le HTML
const sun_elems = document.querySelectorAll(".icon");
...
// 5. Pour chaque icone on bascule  soleil ↔ lune
    sun_elems.forEach(function(icon) {
